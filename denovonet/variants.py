...
#             print('sequence', seq[base_start_position:base_end_position])
#             print("reference", ref[genome_start_position:genome_end_position])
            
#             print(f'base start position {base_start_position}; genome start position {genome_start_position}')
#             print(f'base_end_position {base_end_position}; genome_end_position {genome_end_position}')
#             print(len(seq))
#             print(len(ref))
#             print(len(seq[base_start_position:base_end_position]))
#             print(len(ref[genome_start_position:genome_end_position]))
...
class SingleVariant():
    ...
    def _get_read_encoding(self, read, debug=False):
        ...
        # get reference genome for read
        self._ref = self.REFERENCE_GENOME.fetch(self.reference_chromosome, self._read.reference_start, self._read.reference_end)
